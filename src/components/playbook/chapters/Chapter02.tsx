...
export const Chapter02 = () => (
  <>
    ...
    <SectionBlock title="The Shift Has Already Happened">
      ...
      <PullQuote quote="You are no longer selling the future of finance. You are selling the infrastructure that institutions already moving on-chain are choosing right now." />
    </SectionBlock>
