...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Include links directly in the post body", sub: "LinkedIn's algorithm no longer penalises posts with external links. Add the URL directly in the post where it's most contextual — don't bury it in the comments.", tag: "LinkedIn", tagColor: "bg-blue-500/10 text-blue-400 border-blue-500/20", companies: ["custody","trading","data","compliance","treasury","infra","staking"], buyers: ["bank","fund","fintech","family","crypto","etf","exchange"] },
