...
export const Chapter08 = () => (
  <>
    <SectionBlock>
      <p>Every job description lists "messaging and positioning" as a core skill, but because it is where most crypto companies fail when talking to institutions.</p>
    </SectionBlock>
