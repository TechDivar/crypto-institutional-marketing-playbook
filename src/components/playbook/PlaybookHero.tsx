  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Stairs with perspective — scaled for mobile */}
        <div className="relative overflow-visible flex items-center justify-center" style={{ width: 'min(460px, 85vw)', height: 'min(400px, 50vh)' }}>
          <div className="w-[460px] h-[400px] scale-[0.5] sm:scale-[0.7] md:scale-100 origin-center" style={{ perspective: "800px" }}>
          <motion.div
